/* ============================================================================
   ...
   Libre for display, Assistant for body — the gothic-grimoire pairing) and
   writes a self-contained @font-face stylesheet with the glyph data inlined
   as base64.

   Both families carry Hebrew natively, unlike the Rubik/Poppins pairing this
   replaced, so no fallback subsetting trick is needed — hebrew and latin are
   still the only subsets kept, since this game has no other scripts.
...
const FAMILIES = 'family=Frank+Ruhl+Libre:wght@500;700;900&family=Assistant:wght@400;500;600;700;800';
